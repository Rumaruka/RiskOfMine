...
import com.rumaruka.riskofmine.common.event.PlayerPickupHealEvent;
...
public class EntityHealOrb extends Entity
{
    ...
    public EntityHealOrb(World worldIn, double x, double y, double z, int expValue)
    {
        super(worldIn);
    ...
    public EntityHealOrb(World worldIn)
    {
        super(worldIn);
    ...
    public void onCollideWithPlayer(EntityPlayer player)
    {
        if (!this.world.isRemote)
        {
                ...
                if (net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new PlayerPickupHealEvent(player, this))) return;
