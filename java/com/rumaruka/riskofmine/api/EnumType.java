...
public enum EnumType implements IStringSerializable {
    COMMON(0,4,"Common","common",16383998,TextFormatting.WHITE),
    UNCOMMON(1,3,"Uncommon","uncommon", 6192150, TextFormatting.DARK_GREEN),
    LEGENDARY(2,2,"Legendary","legendary", 11546150, TextFormatting.RED),
    BOSS(3,1,"Boss","boss", 16351261, TextFormatting.GOLD),
    LUNAR(4,0,"Lunar","lunar",3949738,TextFormatting.BLUE);
    ...
    private EnumType(int metaIn, int dyeDamageIn, String nameIn, String unlocalizedNameIn, int colorValue, TextFormatting chatColorIn)
    {
        this.meta = metaIn;
